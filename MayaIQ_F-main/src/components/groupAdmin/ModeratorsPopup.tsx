...
const ModeratorsPopup: React.FC<Props> = ({
  ...
  // Add dummy unblock function for moderators
  const handleDummyUnblock = (userId: number) => {
    // Moderators are not blocked, so this is a no-op
  };
